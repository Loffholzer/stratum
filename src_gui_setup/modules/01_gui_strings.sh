...
export STR_WT_OPT_1="KDE Plasma | Klassisch, anpassbar (Windows-like)"
export STR_WT_OPT_2="COSMIC     | Modernste Technik (Rust/Wayland)"
export STR_WT_OPT_3="GNOME      | Polierter Workflow (macOS-like)"
export STR_WT_OPT_4="XFCE       | Leichtgewicht (Low-Mem)"
export STR_WT_OPT_5="Oberfläche deinstallieren..."
export STR_WT_OPT_6="Zusätzliche Anwendungen..."
export STR_WT_OPT_0="Setup beenden"

export STR_WT_UNINSTALL_TITLE="Stratum OS - Deinstallation"
export STR_WT_UNINSTALL_MSG="Wähle die zu entfernende Oberfläche:"
export STR_WT_OPT_BACK="Zurück"

export STR_WT_APPS_TITLE="Stratum OS - Anwendungen"
...
export STR_WT_OPT_FLATPAK="Flatpak     | Universelles Paketformat & Flathub"
export STR_WT_OPT_KVM="KVM/QEMU    | Virt-Manager für Virtuelle Maschinen"
